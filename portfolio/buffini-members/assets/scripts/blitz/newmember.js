...
function makeBlitzTimer() {
  var endTime = new Date("May 8, 2017 00:00:00 PDT");
...
$(document).ready(function () {
  ...
  $('#weeklyActionStepsSection input[type=checkbox],[type=radio]').click(function () {
    ...
    $.ajax({
      url: "newmember.aspx/updateBlitzTask",
      ...
      success: function (data, status) {
        ...
        $("#yourProgressMeterInfo").html(data.d + ' / 138 <span>Tasks completed</span>');
      },
...
function saveThisWeekTotals(countTotal, area) {
  ...
  $.ajax({
    url: "newmember.aspx/updateBlitzTotals",
